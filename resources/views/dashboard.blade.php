...
<header class="header">
    <br>
    <a href="{{route('admin.logout')}}"><button class="btn btn-dark">Logout</button>
    </a>
      ...
      @foreach ($livro as $livros)
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{route('admin.favoritos')}}" type="submit" value="" name="id"><button class="btn btn-primary">favoritar</button>
              </a>
            </td>
          </tr>
